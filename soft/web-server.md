...
- [__DIR__](http://php.net/manual/ru/language.constants.predefined.php) - это встроенная в PHP константа, которая содержит полный путь к папке, где находится данный PHP-файл (например, `c:\programs\php`)
