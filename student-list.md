...
Я рекомендую использовать для задачи свободную СУБД, вот самые популярные: 

- PostgreSQL
- MySQL (и ее форки MariaDB, Percona)
- SQLite (это встраиваемая в приложение СУБД, она не требует установки сервера СУБД и хранит данные в файлах)
