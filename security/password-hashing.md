...
Вот пример хешей от пароля 'strongpassword': md5('strongpassword') = `f93fc10472a31bb3061aa0b45e228c5a`, sha1('strongpassword') = `2ae868079d293e0a185c671c7bcdac51df36e385`. Здесь хеши записаны в 16-чной системе счисления с помощью символов 0-9, a-f. Обратить хеш-функцию невозможно (по крайней мере, методы для этого не известны), потому вычислить исходный пароль можно только перебором (вычислять хеш от всевозможных паролей до тех пор, пока не попадется нужный).
