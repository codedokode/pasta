...
Также, если у всех наших классов один корневой неймспейс (например `\MyLibrary`), мы можем не создавать для него папку и класть файл с вышеупомянутым классом D в `A/B/C/D.php`
