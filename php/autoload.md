...
Пространство имен (неймспейс) задается для всего файла сразу, и относится ко всем упомянутым к нем названиям классов. Оно задается с помощью ключевого слова `namespace`. Это слово нужно писать в самом начале файла: 
