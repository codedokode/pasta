...
В такой ситуации лучше "перевернуть" этот `if`, поменяв в нем условие, и перенести код внутри за переделы if. Это уменьшит глубину отступов и сделает структуру кода последовательной и более простой: 
